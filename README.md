...
息屏运行现在允许按电源键时进行亮屏(v1.0.2+)<br/>

# 息屏运行使用方式
1.打开lsposed启用Y700Display
2.打开app点击息屏
3.按物理电源键解除息屏 / 在app或控制栏点击解除息屏
...
# 更新日志
v1.0.3 - 2026/01/29<br/>
  新增桌面小组件 支持旁路供电开、旁路供电关、息屏、开屏、修改分辨率(需先打开app) <br/>
  现在第一次打开app不会闪退了，但是还是建议先进行root授权<br/>
